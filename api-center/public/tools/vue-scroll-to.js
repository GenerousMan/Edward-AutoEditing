...
!function(e, n) {
    ...
    var p = function(e, n, c, l) {
        ...
        for (var s = a ? new Float32Array(u) : new Array(u), p = 0; p < u; ++p)
            s[p] = d(p * f, e, c);
        function m(n) {
            for (var a = 0, l = 1, y = u - 1; l !== y && s[l] <= n; ++l)
                a += f;
            ...
            return m >= o ? function(e, n, o, r) {
                ...
                } while (Math.abs(f) > r && ++c < i);return a
            }(n, a, a + f, e, c)
        }
        return function(e) {
    ...
    var O = function() {
        var n, t, o, r, i, u, f, a, c, l, s, d, v, y, w, b, S, O, T, E, x, A, C, D, P = function(e) {
            f && (E = e,
            T = !0)
        };
        function j(e) {
        ...
        function H(e, n, t) {
            d && (e.scrollTop = n),
            s && (e.scrollLeft = t),
            "body" === e.tagName.toLowerCase() && (d && (document.documentElement.scrollTop = n),
            s && (document.documentElement.scrollLeft = t))
        }
        return function(A, C) {
            var D = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            if ("object" === e(C) ? D = C : "number" == typeof C && (D.duration = C),
            !(n = g.$(A)))
                return console.warn("[vue-scrollto warn]: Trying to scroll to an element that is not on the page: " + A);
            ...
            f = D.hasOwnProperty("cancelable") ? !1 !== D.cancelable : L.cancelable,
            ...
            w = function(e) {
                var n = e.scrollTop;
                return "body" === e.tagName.toLowerCase() && (n = n || document.documentElement.scrollTop),
                n
            }(t),
            b = H.top - F.top + i,
            v = function(e) {
                var n = e.scrollLeft;
                return "body" === e.tagName.toLowerCase() && (n = n || document.documentElement.scrollLeft),
                n
            }(t),
            y = H.left - F.left + i,
            T = !1,
            ...
            if (a && a(n),
            O || S)
                return "string" == typeof r && (r = m[r] || m.ease),
                x = p.apply(p, r),
                g.on(t, h, P, {
                    passive: !0
                }),
    ...
    return "undefined" != typeof window && window.Vue && (window.VueScrollTo = A,
