...
from lib.AlphaPose.SPPE.src.utils.img import load_image, cropBox, im_to_torch
from lib.AlphaPose.opt import opt
from lib.AlphaPose.yolo.preprocess import prep_image, prep_frame, inp_to_image
from lib.AlphaPose.pPose_nms import pose_nms, write_json
from lib.AlphaPose.SPPE.src.utils.eval import getPrediction
from lib.AlphaPose.yolo.util import write_results, dynamic_write_results
from lib.AlphaPose.yolo.darknet import Darknet
...
if opt.vis_fast:
    from lib.AlphaPose.fn import vis_frame_fast as vis_frame
else:
    from lib.AlphaPose.fn import vis_frame
...
class DetectionLoader:
    def __init__(self, dataloder, batchSize=1, queueSize=1024):
        # initialize the file video stream along with the boolean
        # used to indicate if the thread should be stopped or not
        self.det_model = Darknet("edit/lib/AlphaPose/yolo/cfg/yolov3-spp.cfg")
        self.det_model.load_weights('edit/lib/AlphaPose/models/yolo/yolov3-spp.weights')
