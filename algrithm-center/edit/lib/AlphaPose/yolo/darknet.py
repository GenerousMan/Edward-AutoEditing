...
try:
    ...
    from lib.AlphaPose.yolo.util import count_parameters as count
    from lib.AlphaPose.yolo.util import convert2cpu as cpu
    from lib.AlphaPose.yolo.util import predict_transform
